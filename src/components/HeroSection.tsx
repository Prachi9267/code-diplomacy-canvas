...
const HeroSection = () => {
    ...
    return (
        <section id="about" className="pt-32 relative overflow-hidden min-h-screen flex items-center justify-center">
            ...
            <img
              src="/lovable-uploads/a597d684-6262-4226-872d-b3e5e77f3b8b.png"
              alt="Cartoon character"
              className="absolute bottom-0 right-5 lg:right-20 w-48 h-auto md:w-64 z-10 animate-float pointer-events-none"
            />
        </section>
    );
};
